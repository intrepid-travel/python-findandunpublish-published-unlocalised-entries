...
def unpublishEntry(contentType, uid, environment, locale):
    '''
    Publishes an entry
    sample url: https://api.contentstack.io/v3/content_types/{content_type_uid}/entries/{entry_uid}/unpublish
    '''
    url = '{region}v3/content_types/{contentType}/entries/{uid}/unpublish'.format(region=region, contentType=contentType, uid=uid)
    body = {
        'entry': {
    ...
    return typicalCreate(body, url, 'entry', False, uid + ' - ' + locale + ' unpublished')
